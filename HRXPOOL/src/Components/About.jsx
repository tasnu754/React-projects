      ...
      >
          ...
          <div
           ...
           className=" flex-1 px-2 xl:px-20 ">
            ...
            <p className="md:text-xl text-start text-[#b7b9bf] ">
            <span className="font-bold text-white">Mission Statement for HRXPOOL:</span>
             <br />
            ...
            <p className="md:text-xl text-start text-[#b7b9bf]">
            <span className="font-bold text-white">Vision Statement for HRXPOOL:</span> <br />

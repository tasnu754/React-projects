...
const Banner = () => {
    return (
       <div
       className="z-0  hero min-h-[60vh] md:min-h-[80vh] w-full"
       style={{
        backgroundImage:
       ...
       >
          ...
          <div className="absolute md:right-[50%] p-4 md:p-0 ">
            <div className="flex  justify-center items-start h-screen lg:w-[80%]  md:pl-12 lg:pl-28 mx-auto mt-8 md:mt-32">
              <div
                data-aos="fade-up"
